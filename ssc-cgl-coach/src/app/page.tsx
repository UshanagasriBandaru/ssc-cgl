...
const features = [
  ...
  },
  {
    icon: "🤖",
    title: "AI Mentor",
    desc: "Ask anything — score predictions, what to study today, doubt solving in Telugu+English. Knows your performance.",
    href: "/mentor",
  ...
  },
  {
    ...
    desc: "One-click plan from your weak topics. PYQ-weighted roadmap with burnout detection.",
    href: "/planner",
    cta: "Build my plan",
  ...
  },
  {
    ...
    desc: "Difficulty adjusts to your performance. 10/25/50 questions. AI error analysis after each test.",
    href: "/mock-tests",
    cta: "Take a mock",
  ...
  {
    icon: "🔁",
    title: "SM-2 Revision Engine",
    desc: "Spaced repetition replaces manual snooze. Pattern alerts when you repeat the same mistake.",
    href: "/revision",
    cta: "Review today",
  ...
  },
  {
    ...
    desc: "Red-to-green topic grid, subject trends, time wastage, and Most Improved badges.",
    href: "/analytics",
    cta: "See analytics",
  ...
  },
  {
    ...
    desc: "Daily targets, 30-day habit calendar, milestone badges at 7/14/30/60 days.",
    href: "/streaks",
    cta: "Track habits",
  ...
  },
  {
    icon: "⏱️",
    title: "Focus Mode",
    desc: "Distraction-free Pomodoro timer. 25-min work + 5-min break. Auto-logs study time.",
    href: "/focus",
    cta: "Start focusing",
  ...
  },
  {
    ...
    desc: "Log wrong answers. AI explains the trap in Telugu+English. SM-2 schedules review.",
    href: "/mistakes",
    cta: "Open notebook",
    color: "from-rose-500 to-pink-600",
  },
